...
> **Frozen excerpt** of the canonical rappid contract (`rapp-rappid/2.0`). Bundled at planting time on 2026-05-09T12:51:35Z.
...
```
rappid:v2:<kind>:@kody-w/heimdall:<32-hex>@github.com/kody-w/heimdall
```
